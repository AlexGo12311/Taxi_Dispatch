...
SECRET_KEY = 'django-insecure-born)#*y*9x55^6qf)+!3np)ids(#jzt@b6=^c$es2ytjy#fu3'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'Dispatch_taxi','static','images')]
